...
public class LoginMagentoSteps {
    ...
    public void userHoverOverGearDropdown() throws InterruptedException {
        Thread.sleep(2000);
        WebElement gearDropdown = driver.findElement(By.xpath("//html[1]/body[1]/div[2]/div[1]/div[1]/div[2]/nav[1]/ul[1]/li[4]/a[1]/span[2]"));
        action.moveToElement(gearDropdown);
//"//span[normalize-space()='Gear']"
    }

    @And("User Select Bags")
    public void userSelectBags() throws InterruptedException {
        WebElement bagsBtn = driver.findElement(By.xpath("/html[1]/body[1]/div[2]/div[1]/div[1]/div[2]/nav[1]/ul[1]/li[4]/ul[1]/li[1]/a[1]/span[1]"));
        wait.until(ExpectedConditions.visibilityOf(bagsBtn));
        action.moveToElement(bagsBtn);
        action.click().build().perform();
//        "//span[normalize-space()='Bags']"
    }
